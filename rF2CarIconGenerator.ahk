...
IsRunningText := ToolGui.Add("Text", "x20 y" status_pos_y + 23 " w250", "")
IsMonitoringText := ToolGui.Add("Text", "x20 y" status_pos_y + 43 " w250", "")
DevModeChecker := ToolGui.Add("Checkbox", "x340 y" status_pos_y + 19 " w70 h20", "Dev Mode")
GenIconChecker := ToolGui.Add("Checkbox", "x310 y" status_pos_y + 39 " w100 h20 Checked", "Generate Icon")
...
VehicleNameText := ToolGui.Add("Edit", "x20 y" vehicleinfo_pos_y + 22 " w222 h21 ReadOnly")
ButtonStart := ToolGui.Add("Button", "x" 247 " y" vehicleinfo_pos_y + 21, "Start Monitoring")
ButtonStart.OnEvent("Click", StartMonitoringStatus)
ButtonStop := ToolGui.Add("Button", "x" 363 " y" vehicleinfo_pos_y + 21, "Stop")
...
; Buttons
button_pos_y := vehicleinfo_pos_y + vehicleinfo_height + 6

ButtonClear := ToolGui.Add("Button", "x" win_margin_x - 1 " y" button_pos_y, "Clear Log")
ButtonClear.OnEvent("Click", DialogConfirmClear)
ButtonRegen := ToolGui.Add("Button", "x" win_margin_x + 73 " y" button_pos_y, "Regenerate Icon")
ButtonRegen.OnEvent("Click", DialogConfirmRegen)
ButtonAbout := ToolGui.Add("Button", "x366 y" button_pos_y, "About")
